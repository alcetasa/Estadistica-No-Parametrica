...
################################
#Prueba de detección de Outliers: Pregunta 8
################################
boxplot(Caso$Monto,col=3)

library(outliers)
#Prueba de Grubbs
grubbs.test(Caso$Monto,two.sided = T)

#Prueba de Dixon
dixon.test(Caso$Monto, type=22, two.sided=T)

dixon.test(Caso$Monto[1:25], type=22, two.sided=T)
